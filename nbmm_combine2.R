...
directory_path <-   "~/scratch/dataset/new_sim/nbmm_res/" 
mod_path <-   "~/scratch/dataset/new_sim/nbmm_mod/"
...
saveRDS(res, file = paste0(getwd(), "/reproducible/new_sim/data/nbmm_parametric.rds"))
