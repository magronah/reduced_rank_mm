...
path
####################################################################
data      =   readRDS(paste0(path,"sim_data/deseq_noShrink_otu_meta_list_withzi_taxa.rds"))
################################################################
...
file_path  =  paste0("~/scratch/dataset/RR/coverage","/",nsubj,"_",ntaxa,"/","deseq_noShrink/")
