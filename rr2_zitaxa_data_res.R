...
path =   "~/scratch/dataset/new_sim/rr_mod2zitaxa/mod"
...
saveRDS(dd, file = paste0("~/scratch/dataset/new_sim/rr_mod2zitaxa_res/res",i, ".rds"))
#rr_mod2zitaxa  rr_mod2zitaxa_res
